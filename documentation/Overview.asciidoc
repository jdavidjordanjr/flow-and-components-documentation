...
* A set of beautiful UI components built with focus on end-user and developer experience
...
It is based on the HTML5 History API, and makes it possible for the user to navigate pages backward and forward,
